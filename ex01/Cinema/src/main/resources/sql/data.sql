INSERT INTO ex01.films(id, title, year, age_restrictions, description, poster_id)
VALUES
...
INSERT INTO ex01.halls(id, serial_number, number_of_seats)
VALUES
    (1, 1, 30),
    (2, 2, 50),
    (3, 3, 10)
...
INSERT INTO ex01.sessions(id, film_id, hall_id, price, date_time)
VALUES
